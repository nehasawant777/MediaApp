...
<script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
	...
	<nav class="navbar navbar-light bg-light">
       ...
       <!--   <button type="button" class="btn btn-primary" onclick="redirect:/viewNotification">
...
<div class="container">
	<div class="row">
		...
		<a:forEach var="i" items="${notifications}">
  <a href="${i.notifyPostUrl}" class="list-group-item list-group-item-action">${i.notifyFrom} ${i.notificationType}</a> 
		</a:forEach>
		</div>
<!-- table class="table">
<thead>
