...
<div class="container">
All Applicaion Users
	 <div class="row">
		<div class="list-group">
		<a:forEach var="i" items="${users}">
		<a:set var="val1" value="${i.id}"></a:set>
      <a:if test="${val1!='112707702924049'}">
      <a href="/FriendProfile?friendId=${i.id}" > 
				<c:out value = "${i.name}"/>
  					<button type="button" class="list-group-item list-group-item-action">"${i.name}"</button>
  					<input type="hidden" id="postID" name="postID" value="${i.id}"/>
				</a>
      </a:if> 
